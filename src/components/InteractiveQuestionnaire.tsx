...
const QUESTIONS = {
  ...
  q8: '¿Los miembros del CSST o Supervisor han sido capacitados?',
  q9: '¿El CSST o Supervisor se reúne mensualmente y tiene Libro de Actas?',
